		...
		routes: [
			{
				...
				aliases: {
					'POST /'(req, res) {
						...
						return this.broker
							.call('minio.putObject', stream, { meta: req.body })
							.then((result) => {
			...
			},
			{
				...
				aliases: {
					'POST /'(req, res) {
						return this.broker
							.call('minio.fPutObject', req.body)
							.then((result) => {
								this.logger.info('Object saved', result);
								nodeRes.send(req, res, result);
							})
			...
			},
			{
				...
				aliases: {
					'POST /'(req, res) {
						...
						return this.broker
							.call('minio.presignedUrl', options)
							.then((result) => {
								nodeRes.send(req, res, result);
							})
							.catch((err) => {
			...
			},
			{
				...
				aliases: {
					'POST /'(req, res) {
						const options = Object.assign({}, req.body, { requestDate: new Date() });
						return this.broker
							.call('minio.presignedGetObject', options)
							.then((result) => {
								nodeRes.send(req, res, result);
							})
							.catch((err) => {
			...
			},
			{
				...
				aliases: {
					'POST /'(req, res) {
						const options = Object.assign({}, req.body, { requestDate: new Date() });
						return this.broker
							.call('minio.presignedPutObject', options)
							.then((result) => {
								nodeRes.send(req, res, result);
							})
							.catch((err) => {
			...
			},
			{
				...
				aliases: {
					'POST /'(req, res) {
						return this.broker
							.call('minio.presignedPostPolicy', req.body)
							.then((result) => {
								nodeRes.send(req, res, result);
							})
							.catch((err) => {
