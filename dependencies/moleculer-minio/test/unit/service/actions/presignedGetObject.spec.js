		...
		describe('presigedUrl', () => {
			it('creates and returns a Presigned URL for obtaining an Object', () => {
				...
				return Promise.delay(100)
					.then(() =>
						context.client.presignedGetObject.mock.calls[0][5](null, 'https://example.com'),
					)
					.then(() => creating)
					.then((r) => {
						...
						expect(context.client.presignedGetObject.mock.calls[0][4]).toEqual(
			...
			it('rejects with errors encountered', () => {
				...
				return Promise.delay(100)
					.then(() =>
						context.client.presignedGetObject.mock.calls[0][5](new Error('Something went wrong')),
					)
					.then(() => creating)
					.catch((e) => {
