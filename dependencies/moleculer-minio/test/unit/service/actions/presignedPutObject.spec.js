		...
		describe('presigedUrl', () => {
			it('creates and returns a Presigned URL for creating an Object', () => {
				...
				return Promise.delay(100)
					.then(() =>
						context.client.presignedPutObject.mock.calls[0][3](null, 'https://example.com'),
					)
					.then(() => creating)
					.then((r) => {
			...
			it('rejects with errors encountered', () => {
				...
				return Promise.delay(100)
					.then(() =>
						context.client.presignedPutObject.mock.calls[0][3](new Error('Something went wrong')),
					)
					.then(() => creating)
					.catch((e) => {
